...
@section('content')
    <div class="col-md-9">
        ...
        <div class="col-md-9">
            ...
            <div>
                <b> Адрес: {{$firm->address}}</b>
            </div>
            <div>
                <b> Телефоны: {{$firm->phone}}</b>
            </div>
        </div>
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td rowspan="2">{{$firm->account}}</td>
            </tr>
            <tr>
                <td colspan="2">{{$firm->name}} <br>Получатель</td>
            </tr>
            <tr>
                <td rowspan="2" colspan="2">{{$firm->namebank}} <br>Банк получателя</td>
                <td>БИК</td>
                <td>{{$firm->bikbank}}</td>
            </tr>
            <tr>
        ...
        <button id="addpretension" type="button" class="btn btn-default">
        ...
        <input type="hidden" name="contractor_id" id="contractor_id" value="{{$contractor->id}}" />
